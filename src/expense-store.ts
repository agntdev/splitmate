...
export function getStore(): ExpenseStore {
  ...
  if (redisUrl) {
    ...
    const client = new Redis(redisUrl, { maxRetriesPerRequest: null, lazyConnect: false }) as RedisLike;
