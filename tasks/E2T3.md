# E2T3 — /clear command implementation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SPLT

Implement the /clear command to delete all saved expenses for the user. Add a test spec in tests/specs/E2T3.json and append the command to tests/commands.json.
