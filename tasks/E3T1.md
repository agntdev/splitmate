# E3T1 — /start command implementation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SPLT

Implement the /start command to display a welcome message and a one-line usage hint. Add a test spec in tests/specs/E3T1.json and append the command to tests/commands.json.
