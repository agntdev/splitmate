# E2T1 — /save command implementation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SPLT

Implement the /save command to store a named expense in Redis. Add a test spec in tests/specs/E2T1.json and append the command to tests/commands.json.
