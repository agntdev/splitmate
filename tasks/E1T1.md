# E1T1 — /split command implementation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SPLT

Implement the /split command to handle the splitting logic, including validation of inputs and distribution of amounts. Add a test spec in tests/specs/E1T1.json and append the command to tests/commands.json.
