# E2T2 — /list command implementation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SPLT

Implement the /list command to display all saved expenses for the user in descending timestamp order. Add a test spec in tests/specs/E2T2.json and append the command to tests/commands.json.
